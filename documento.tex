...
\autor{João Victor De França Leitão, João Vitor Moreira Duarte e Francisco Yuri Carvalho de Oliveira}
\titulo{Inteligência Artificial: Uso de inteligência artificial no jogo de xadrez online}
\local{Maracanaú - CE}
\data{2023}
...
\input{elementos-textuais/referencial}
